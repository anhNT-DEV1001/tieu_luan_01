...
SECRET_KEY = os.getenv("SECRET_KEY", "payment-service-secret")
...
if os.getenv("DB_HOST"):
    db_schema = os.getenv("DB_SCHEMA", "payment_service")
    DATABASES = {
        "default": {
...
ORDER_SERVICE_URL = os.getenv("ORDER_SERVICE_URL", "http://ecommerce-order-service:8003/api/orders/")
